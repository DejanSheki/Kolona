	...
	<div class="container">
		...
		<div class="contwrap">
            ...
            <div class="menu" data-aos="zoom-in-up" data-aos-duration="1500">
                ...
                <p class="menu_span">Fish roasted in salt (1 kg)</p><p class="menu_price">220,00 kn</p>
                <p class="menu_span">Fish roasted in salt (dish)</p><p class="menu_price">150,00 kn</p>
                <p class="menu_span">Rye in white wine</p><p class="menu_price">100,00 kn</p>
                <p class="menu_span">Roasted octopus with potatoes</p><p class="menu_price">120,00 kn</p>
            </div>	
            <div class="menu" data-aos="zoom-in-up" data-aos-duration="1500">
                <h2 class="center">GRILLED MEAT</h2>
                <p class="menu_span">Beaf steak</p><p class="menu_price">100,00 kn</p>
                <p class="menu_span">Pepper steak</p><p class="menu_price">115,00 kn</p>
                <p class="menu_span">Rumpsteak</p><p class="menu_price">75,00 kn</p>
                <p class="menu_span">Shish-kebab</p><p class="menu_price">60,00 kn</p>
                <p class="menu_span">Ćevapčići (Bosnian dish)</p><p class="menu_price">60,00 kn</p>
                <p class="menu_span">Dalmatian-style beef escalope </p><p class="menu_price">75,00 kn</p>
                <p class="menu_span">Meat plate (2 persons) </p><p class="menu_price">100,00 kn</p>
                <p class="menu_span">Chicken</p><p class="menu_price">50,00 kn</p>
                <p class="menu_span">Turkey shish-kebab</p><p class="menu_price">60,00 kn</p>
            </div>		
            <div class="menu dessert" data-aos="zoom-in" data-aos-duration="1500">
                <h2 class="center">DESSERTS</h2>
                <p class="menu_span">Pancakes</p><p class="menu_price">20,00 kn</p>
                <p class="menu_span">Dubrovnik-style rozata (caramel cream)</p><p class="menu_price">20,00 kn</p>
                <p class="menu_span">Ice-cream </p><p class="menu_price">20,00 kn</p>
                <p class="menu_span">Banana split </p><p class="menu_price">25,00 kn</p>
                <p class="menu_span">Fruit salad </p><p class="menu_price">25,00 kn</p>
                <p class="menu_span">Fruit salad </p><p class="menu_price">25,00 kn</p>
            </div>						
		</div>
